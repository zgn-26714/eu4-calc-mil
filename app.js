...
const UNIT_TRANSLATIONS = {
  ...
  "Yaya Infantry": "亚亚步兵",
  "Azab Infantry": "阿扎布步兵",
  "Janissary Infantry": "耶尼切里近卫军",
  "Sekban Infantry": "塞克班步兵",
  "Reformed Janissary Infantry": "改良耶尼切里近卫军",
  "Nizami Cedid Infantry": "新秩序步兵",
  "Eastern Carabinier": "东欧卡宾枪步兵",
  "Eastern New Model Infantry": "东欧新模范步兵",

  // === 安纳托利亚（奥斯曼）骑兵 ===
  "Musellem Cavalry": "穆塞勒姆骑兵",
  "Timariot Cavalry": "蒂玛尔骑兵",
  "Spahi Cavalry": "西帕希骑兵",
  "Reformed Spahi Cavalry": "改良西帕希骑兵",
  "Toprakli Hit and Run Cavalry": "托普拉克利袭扰骑兵",
  "Eastern Skirmisher": "东欧散兵",
  "Eastern Uhlan": "东欧乌兰骑兵",
  ...
  "Muslim Musketeer": "穆斯林火枪兵",
  "Afsharid Reformed Infantry": "阿夫沙尔改良步兵",
  "Reformed Muslim Musketeers": "改良穆斯林火枪兵",
  ...
  "Asian Musketeer": "亚洲火枪兵",
  "Reformed Asian Musketeer": "改良亚洲火枪兵",
  ...
  // === 游牧步兵 ===
  "Eastern Archers": "东欧弓箭手",
  "Steppe Raiders": "草原突袭步兵",
  "Steppe Footmen": "草原步兵",
  "Steppe Musketeers": "草原火枪兵",
  "Steppe Infantry": "草原步兵队",
  "Steppe Rifles": "草原线膛枪兵",
  "Reformed Steppe Rifles": "改良草原线膛枪兵",

  // === 游牧骑兵 ===
  "Eastern Steppe Cavalry": "东部草原骑兵",
  "Eastern Swarm Cavalry": "东部集群骑兵",
  "Steppe Riders": "草原骑手",
  "Steppe Lancers": "草原枪骑兵",
  "Mounted Steppe Raiders": "草原骑乘突袭兵",
  "Steppe Cavalry": "草原骑兵队",
  ...
  "Central African Musketeers": "中非火枪兵",
  "East African Musketeers": "东非火枪兵",
  "North African Musketeers": "北非火枪兵",
  "South African Musketeers": "南非火枪兵",
  "Central African Guerrillas": "中非游击兵",
  "East African Guerrillas": "东非游击兵",
  "North African Guerrillas": "北非游击兵",
  "Westernized Central African Inf.": "西化中非步兵",
  "Westernized East African Inf.": "西化东非步兵",
  "Westernized North African Inf.": "西化北非步兵",
  "Westernized South African Inf.": "西化南非步兵",
  "African Western Franchise Infantry": "非洲西式特许步兵",
  ...
  "American Forest Musketeers": "美洲丛林火枪兵",
  "American Hill Musketeers": "美洲山地火枪兵",
  "Offensive American Musketeers": "美洲进攻火枪兵",
  "American Guerrilla Warfare": "美洲游击战步兵",
  "Central American Guerrillas": "中美洲游击兵",
  "Westernized American Hill Infantry": "西化美洲山地步兵",
  "Westernized American Plains Infantry": "西化美洲平原步兵",
  "Westernized Central American infantry": "西化中美洲步兵",
  "Clubmen": "棍棒兵",
  ...
  "North American Guerrillas": "北美游击兵",
  "American Westernized Infantry": "美洲西化步兵",
  ...
  "Defensive American Musketeers": "美洲防御火枪兵",
  "South American Arquebusier": "南美火绳枪兵",
  "Reformed American Musketeers": "改良美洲火枪兵",
  "Incan Guerrilla": "印加游击兵",
  "South American Guerrilla": "南美游击兵",
  "Westernized Incan Infantry": "西化印加步兵",
  "Westernized South American Infantry": "西化南美步兵",
  "Reformed Westernized Incan Infantry": "改良西化印加步兵",
  ...
  "Polynesian Riflemen": "波利尼西亚线膛枪兵",
  "Polynesian Guerrillas": "波利尼西亚游击兵",
